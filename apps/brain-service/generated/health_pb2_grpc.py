...
class HealthStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Check = channel.unary_unary(
                '/identra.health.v1.Health/Check',
        ...
        self.Watch = channel.unary_stream(
                '/identra.health.v1.Health/Watch',
                request_serializer=health__pb2.HealthCheckRequest.SerializeToString,
                response_deserializer=health__pb2.HealthCheckResponse.FromString,
                _registered_method=True)
...
def add_HealthServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'identra.health.v1.Health', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('identra.health.v1.Health', rpc_method_handlers)
